            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-primary mt-0.5">View full product information</p>
                    </div>
                </div>
                <Button
                    size="sm"
                            ...
                            <div className="flex flex-wrap items-center gap-1 mt-2">
                                {categoryHierarchy.map((c, i) => (
                                    <span key={i} className="flex items-center gap-1">
                                        <span className="text-[11px] bg-primary/10 text-primary px-1.5 py-0.5 rounded font-medium">{c}</span>
                        ...
                        <div className="bg-gray-50 rounded-xl border border-gray-100 divide-y divide-gray-100">
                            ...
                            {price > 0 && (
                                <div className="flex justify-between items-center px-4 py-2.5">
                                    ...
                                    <span className="text-xs font-semibold text-primary bg-primary/10 px-2 py-0.5 rounded">{fmt(price)}</span>
                                </div>
                            )}
                            {taxInfo && taxRate > 0 && (
                                <div className="flex justify-between items-center px-4 py-2.5">
