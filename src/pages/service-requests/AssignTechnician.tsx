                ...
                <div className="space-y-4">
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                        <div className="px-3 py-2 border-b border-gray-100 bg-gray-50/50">
                            <h3 className="text-xs font-bold text-gray-900 capitalize tracking-wider">Request Summary</h3>
                        </div>
                        <div className="p-3 space-y-3">
                            <div className="space-y-1">
                                <p className="text-[12px] font-bold text-gray-400 capitalize tracking-wider">Customer</p>
                            ...
                            <div className="space-y-1">
                                <p className="text-[12px] font-bold text-gray-400 capitalize tracking-wider">Device Info</p>
                                <div className="bg-gray-50 rounded-md p-2 border border-gray-100">
                            ...
                            <div className="space-y-1">
                                <p className="text-[12px] font-bold text-gray-400 capitalize tracking-wider">Current Status</p>
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div className="p-4 space-y-4">
                            <div className="space-y-2">
                                <label className="text-[12px] font-bold text-gray-500 capitalize tracking-wider">Select Technician</label>
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[12px] font-bold text-gray-500 capitalize tracking-wider">Internal Instructions</label>
                                <Textarea 
                                    placeholder="Add notes or specific instructions for the technician..."
                                    value={description}
                                    onChange={(e) => setDescription(e.target.value)}
                                    className="min-h-[80px] text-sm border-gray-200 resize-none focus:ring-primary/20"
                                />
                            </div>

                            <div className="bg-primary/5 rounded-md p-2.5 border border-primary/20 flex items-start gap-2">
